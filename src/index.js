...
void inquirer
    ...
    if (changemylife === "Study in Bootcamp ISDI") {
        ...
        console.log("Mario killed you, he said you were a rojo and his students got you");
    }
    else if (changemylife === "Study in a FP informatica") {
        console.log("soy programador jaja fasfa nEHidhchunhiasda342344231jaddwwnw xd lol");
    }
